...
export default function SectionHero() {
  ...
  return (
    <div className="wrapper flex flex-col md:flex-row gap-6 md:gap-0 overflow-x-hidden">
      <AnimatedElement className="flex flex-1 min-w-3/12 justify-center items-center flex-col">
      ...
      <div className="flex flex-2 justify-center items-center relative">
        <Image
          ...
          className="max-w-full w-full h-fit z-10 will-change-transform"
        />
      ...
      <AnimatedElement delay={0.2} className="flex flex-1 min-w-3/12 justify-center items-center lg:items-end flex-col font-heading font-semibold relative z-10 cursor-default">
